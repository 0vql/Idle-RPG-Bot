const messages = {
  ...
  event: {
    camp: [
      ...
      {
        eventMsg:
          '[\`$$\`] ## sat by a stream in $$ and listened to the water while catching ^^ breath.',
      ...
      {
        eventMsg:
          '[\`$$\`] ## was startled by rustling in the bushes near $$, but relaxed once it passed.',
        eventLog: 'Was startled by rustling near $$ but it was nothing',
      },
      {
        eventMsg:
          '[\`$$\`] ## spent the rest period in $$ watching the clouds and gathering ^^ thoughts.',
      ...
      {
        eventMsg:
          '[\`$$\`] ## lit a small fire near $$ and cooked a simple meal from foraged scraps.',
        eventLog: 'Cooked a simple meal over a small fire near $$',
      },
      {
        eventMsg:
          '[\`$$\`] ## sat on a mossy log in $$ and polished ^^ equipment until it gleamed.',
      ...
      {
        eventMsg:
          '[\`$$\`] ## took shelter under an overhang near $$ as the wind picked up overhead.',
      ...
      {
        eventMsg:
          '[\`$$\`] ## traded a nod with a passing traveller near $$ before both went their separate ways.',
        eventLog: 'Exchanged a nod with a passing traveller near $$',
      },
      {
        eventMsg:
          '[\`$$\`] ## watched a hawk circle overhead near $$ while stretching out tired limbs.',
        eventLog: 'Watched a hawk circle overhead near $$ while resting',
      },
      {
        eventMsg:
          '[\`$$\`] ## dug a shallow fire pit near $$, warmed up, then covered the tracks carefully.',
    ...
    item: [
      ...
      {
        eventMsg:
          '[\`$$\`] ## stumbles upon a grizzly scene. One of the corpses has \`%%\` next to it! Seems like it is in good enough condition to use.',
      ...
      {
        eventMsg:
          '[\`$$\`] ## catches a glint out of the corner of ^^ eye. Brushing aside some leaves ## finds \`%%\` left here by the last person to camp at this spot.',
        eventLog: 'Near your camp in $$ there was %%',
      },
      {
        eventMsg:
          '[\`$$\`] ## notices something reflecting inside a nearby cave. Exploring it further && find \`%%\` resting against a wall.',
        eventLog: 'While exploring a cave in $$ you found %%',
      },
      {
        eventMsg:
          "[\`$$\`] ## finds a grave with \`%%\` sitting on it. The dead do not need equipment so it's yours for the taking",
        eventLog: 'You stole %% from a grave in $$',
      },
      {
        eventMsg:
          '[\`$$\`] ## looks around a derlict building and finds \`%%\` in one of the corners.',
